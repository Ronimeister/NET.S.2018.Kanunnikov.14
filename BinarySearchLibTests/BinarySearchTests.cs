...
namespace BinarySearchLibTests
{
    ...
    public class BinarySearchTests
    {
        ...
        [TestCase(new double[] { 1, 2, 3, 4 }, 6, ExpectedResult = null)]
        ...
        [TestCase(new int[] { 1, 2, 3, 4 }, 6, ExpectedResult = null)]
        ...
        {
            Comparer<object> comparer = null;
            Assert.Throws<ArgumentNullException>(() => BinarySearch<object>.Search(new object[] { 1, 2, 3 }, 1, comparer));
        }

        [Test]
        public void BinarySearch_NullComparison_ArgumentNullException()
        {
            Comparison<object> comparison = null;
            Assert.Throws<ArgumentNullException>(() => BinarySearch<object>.Search(new object[] { 1, 2, 3 }, 1, comparison));
        }
    }
}
